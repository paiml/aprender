# Release cell receipt — lambda-labs / gpu / qwen2.5-coder-7b-instruct-q4_k_m
...
| | |
|---|---|
| host | `lambda-labs` (x86_64) |
| GPU | NVIDIA GeForce RTX 4090, driver 570.207, cap 8.9, 24564 MiB |
| backend under test | `gpu` |
| binary | `apr 0.65.2`, sha256 `776cbbdb4306b5d89f2f9542b88570517248e7820d1ab80c83a7a7bdde963b21` — built from the L0-1b tree, NOT a release asset (see M1) |
...
| id | gate | result |
|---|---|---|
| **M3** | CPU/GPU parity over >= 64 positions | **GREEN** — 78 positions, 283 op rows, `first_divergence: None`, `lm_head` min cosine **0.9995797276496887**, worst op ffn_out@layer23 = 0.994065 |
