# Release cell receipt — gx10 / gpu / qwen2.5-coder-7b-instruct-q4_k_m
...
|---|---|
| host | `gx10` (aarch64) |
| GPU | NVIDIA GB10, driver 590.48.01, cap 12.1, unified memory |
...
| id | gate | result |
|---|---|---|
| **M3** | CPU/GPU parity over >= 64 positions | **GREEN** — 78 positions, 283 op rows, `first_divergence: None`, `lm_head` min cosine **0.9997819066047668**, worst op attention@layer22 = 0.996844 |
