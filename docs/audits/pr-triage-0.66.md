...
| #2720 | 8 | 44 | CONFLICTING/DIRTY | gate, workspace-test | — | CONFLICT | **HOLD:DEC-D-3** | 8 | labelled pp-066/hold (merge/conflict removed), commented "held on D-3 decision" |
...
| #2793 | 6 | 15 | MERGEABLE/UNSTABLE | pr-review-receipt | — | CLEAN | **MERGE-NOW** | 6 | rebased clean -> push; NOT armed (workflow file silicon-nightly.yml; operator arms) |
...
- `open_prs_below_2981_by_noahgift`: expected 7, actual 11 → **FAIL** (`gh pr list --state open --limit 100 --json number,author --jq '[.[]|select(.number<2981 and .author.login=="noahgift")|.number]'`) — 2575,2720,2793,2800,2801,2802,2807,2838,2848,2858,2871
