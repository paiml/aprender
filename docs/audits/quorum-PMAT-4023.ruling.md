# Cop ruling on the PMAT-4023 quorum round (2026-09-24)

- **Round judged head:** `54157e6ee`
...
- **Artifact:** `docs/audits/quorum-PMAT-4023.json`, with `agreed: true` and receipt-lint ok.
