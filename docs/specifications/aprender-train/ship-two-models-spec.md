...
| AC-SHIP1-003  | Convert to APR via `apr convert --quantize q4_k_m`; round-trip weights match (cos ≥ 0.999) | FALSIFY-SHIP-003 **(PARTIAL_ALGORITHM_LEVEL v2.28.0)** |
| AC-SHIP1-004  | Export to GGUF via `apr export --format gguf`; loads in llama.cpp         | FALSIFY-SHIP-004 **(PARTIAL_ALGORITHM_LEVEL v2.29.0)** |
