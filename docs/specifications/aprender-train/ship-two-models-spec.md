...
| 2 (live-wire, pending) | Wire `SharedTrainer::CudaVariant` → existing `CudaTransformerTrainer`; mirror `loader/mod.rs:227` dispatch in `drive_real`; `nvidia-smi` residency probe consuming `gputrain_003::verdict_from_residency` | 2 days   |
