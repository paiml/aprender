<!-- PCU: cli-prometheus-lint | contract: contracts/apr-page-cli-prometheus-lint-v1.yaml -->
...
Run `apr prometheus-lint --help` for the complete option list.
