...
# Run CI's guard jobs locally, every step, from ci.yml's own run: blocks (#4416)
guards-local: ## Run the guard-cargo/guard-tree steps CI runs, all of them, streaming
	@bash scripts/ci_guards_local.sh --check-coverage
	@bash scripts/ci_guards_local.sh
