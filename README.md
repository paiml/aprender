...
| Provable contracts | **1787** provable contracts | `find contracts/ -name '*.yaml'` |
...
│   └── ... (82 crates total)
├── contracts/                      # 1787 provable YAML contracts
...
1787 contracts across inference, training, quantization, attention, FFN,
