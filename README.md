...
| Provable contracts | **1781** provable contracts | `find contracts/ -name '*.yaml'` |
...
│   └── ... (82 crates total)
├── contracts/                      # 1781 provable YAML contracts
...
1781 contracts across inference, training, quantization, attention, FFN,
