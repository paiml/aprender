...
| Provable contracts | **1797** provable contracts | `find contracts/ -name '*.yaml'` |
...
│   └── ... (82 crates total)
├── contracts/                      # 1797 provable YAML contracts
...
1797 contracts across inference, training, quantization, attention, FFN,
