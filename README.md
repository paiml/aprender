...
| Provable contracts | **1799** provable contracts | `find contracts/ -name '*.yaml'` |
...
│   └── ... (82 crates total)
├── contracts/                      # 1799 provable YAML contracts
...
1799 contracts across inference, training, quantization, attention, FFN,
