...
| Provable contracts | **1808** provable contracts | `find contracts/ -name '*.yaml'` |
...
│   └── ... (82 crates total)
├── contracts/                      # 1808 provable YAML contracts
...
1808 contracts across inference, training, quantization, attention, FFN,
