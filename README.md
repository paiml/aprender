...
| Provable contracts | **1794** provable contracts | `find contracts/ -name '*.yaml'` |
...
│   └── ... (82 crates total)
├── contracts/                      # 1794 provable YAML contracts
...
1794 contracts across inference, training, quantization, attention, FFN,
