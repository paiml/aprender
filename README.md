...
| Provable contracts | **<!-- CONTRACT_COUNT_START -->1839<!-- CONTRACT_COUNT_END -->** provable contracts | `find contracts/ -name '*.yaml'` (generated by `make readme-sync`, guarded by `scripts/check_readme_claims.sh`) |
