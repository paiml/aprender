...
| Provable contracts | **1784** provable contracts | `find contracts/ -name '*.yaml'` |
...
│   └── ... (82 crates total)
├── contracts/                      # 1784 provable YAML contracts
...
1784 contracts across inference, training, quantization, attention, FFN,
