...
| Provable contracts | **1796** provable contracts | `find contracts/ -name '*.yaml'` |
...
│   └── ... (82 crates total)
├── contracts/                      # 1796 provable YAML contracts
...
1796 contracts across inference, training, quantization, attention, FFN,
