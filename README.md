...
| Provable contracts | **1821** provable contracts | `find contracts/ -name '*.yaml'` |
...
│   └── ... (82 crates total)
├── contracts/                      # 1821 provable YAML contracts
...
1821 contracts across inference, training, quantization, attention, FFN,
