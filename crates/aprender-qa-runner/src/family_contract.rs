...
///
/// Use `to_arch_constraints()` to convert to `aprender_qa_gen::ArchConstraints`
...
impl Constraints {
    /// Convert to `aprender_qa_gen::ArchConstraints` for kernel profile generation.
    #[must_use]
    pub fn to_arch_constraints(&self) -> aprender_qa_gen::ArchConstraints {
        aprender_qa_gen::ArchConstraints {
...
impl SizeVariant {
    /// Convert to `aprender_qa_gen::ArchSizeVariant` for kernel profile generation.
    #[must_use]
    pub fn to_arch_size_variant(&self) -> aprender_qa_gen::ArchSizeVariant {
        aprender_qa_gen::ArchSizeVariant {
