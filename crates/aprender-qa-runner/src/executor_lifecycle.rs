...
impl Executor {
    ...
    fn execute_serve_groups(
        ...
        for (_key, group) in groups {
            ...
            #[cfg(not(feature = "serve-battery"))]
            let evidence_vec: Vec<Evidence> = vec![Evidence::skipped(
                "G2-SERVE", first.clone(), "serve-battery feature disabled (PMAT-534 monorepo migration)",
            )];
