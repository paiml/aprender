impl Executor {
    ...
    fn integrity_scenario(model_id: &ModelId) -> aprender_qa_gen::QaScenario {
        aprender_qa_gen::QaScenario::new(
            model_id.clone(),
            aprender_qa_gen::Modality::Run,
            aprender_qa_gen::Backend::Cpu,
            aprender_qa_gen::Format::SafeTensors,
    ...
    fn layout_scenario(model_id: &ModelId) -> aprender_qa_gen::QaScenario {
        aprender_qa_gen::QaScenario::new(
            model_id.clone(),
            aprender_qa_gen::Modality::Run,
            aprender_qa_gen::Backend::Cpu,
    ...
    fn validate_scenario(model_id: &ModelId) -> aprender_qa_gen::QaScenario {
        aprender_qa_gen::QaScenario::new(
            model_id.clone(),
            aprender_qa_gen::Modality::Run,
            aprender_qa_gen::Backend::Cpu,
    ...
    fn pull_scenario(model_id: &ModelId) -> aprender_qa_gen::QaScenario {
        aprender_qa_gen::QaScenario::new(
            model_id.clone(),
            aprender_qa_gen::Modality::Run,
            aprender_qa_gen::Backend::Cpu,
