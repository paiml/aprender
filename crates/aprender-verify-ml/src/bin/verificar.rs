...
# Generated by aprender-verify distill
...
"#
            ...
            println!("  3. Evaluate with `aprender-verify evaluate --model {model_path}`");
        }
        ...
        Commands::Codex {
            ...
            if corpus {
                ...
                println!("  1. Run `aprender-verify verify --input {output}/augmented.json`");
                println!("  2. Run `aprender-verify train --input {output}/verified/`");
                println!("  3. Run `aprender-verify export --input {output}/verified/`");
            }
        }
