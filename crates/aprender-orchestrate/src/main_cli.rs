...
#[derive(Parser)]
#[command(name = "batuta")]
#[command(version = concat!(env!("CARGO_PKG_VERSION"), " (", env!("APR_GIT_SHA"), ")"), about = "Sovereign AI orchestration: agents, ML serving, code analysis, and transpilation", long_about = None)]
