...
impl ReplSession {
    ...
    pub fn export_history(&self) -> String {
        ...
        script.push_str("# aprender-data session export\n");
        ...
        for cmd in &self.history {
            ...
            let _ = writeln!(script, "aprender-data {}", batch_cmd);
        }
...
mod tests {
    ...
    fn test_session_export_history() {
        ...
        assert!(script.contains("aprender-data load test.parquet"));
        assert!(script.contains("aprender-data head 5"));
    }
    ...
    fn test_session_export_history_with_active_dataset() {
        ...
        let script = session.export_history();
        assert!(script.contains("aprender-data info test.parquet"));
        assert!(script.contains("aprender-data schema test.parquet"));
        assert!(script.contains("aprender-data head test.parquet"));
    }
