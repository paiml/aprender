...
mod completions_surface_2459; // /v1/completions must end at the model's EOS and honour top_p; a context overflow is 4xx on the chat route too; batch completions use the tokenizer
