...
impl CudaExecutor {
    ...
    fn prefill_eager(
        ...
        let hidden_buf1_len = self
            ...
            .hidden_buf1
            .as_ref()
            .expect("hidden_buf1 must be allocated before prefill")
            .len();
        ...
        let hidden_buf2_len = self
            ...
            .hidden_buf2
            .as_ref()
            .expect("workspace hidden_buf2 must be allocated before prefill")
            .len();
        ...
        let input_staging_len = self
            ...
            .input_staging
            .as_ref()
            .expect("CUDA prefill buffer must be allocated")
            .len();
        let q_buf_ptr = self
            .workspace
            .q_buf
