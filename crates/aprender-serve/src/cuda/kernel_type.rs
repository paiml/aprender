...
pub enum KernelType {
    ...
    /// #4234: [`MwvQ6KGemv`](Self::MwvQ6KGemv) for `m` activation vectors in one
    /// launch, bitwise the single-vector kernel per vector.
    BatchedMwvQ6KGemv {
        k: u32,
        n: u32,
    ...
    /// #4234: [`Q5KGemv`](Self::Q5KGemv) for `m` activation vectors in one launch,
    /// bitwise the single-vector kernel per vector.
    BatchedQ5KGemv { k: u32, n: u32, m: u32 },
