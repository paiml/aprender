...
pub enum KernelType {
    ...
    GemmTensorCore { m: u32, n: u32, k: u32 },
    ...
    GemmFp16TensorCore { m: u32, n: u32, k: u32 },
    ...
    CoalescedQ6KGemv { k: u32, n: u32 },
    /// PAR-130: Batched Q6_K GEMV for M>1 batch processing
    BatchedQ6KGemv { k: u32, n: u32, m: u32 },
    ...
    MwvQ6KGemv { k: u32, n: u32, num_warps: u32 },
    ...
    RmsNorm { hidden_size: u32, epsilon: f32 },
    /// PAR-081: Vectorized RMSNorm kernel with 256 threads
    VectorizedRmsNorm { hidden_size: u32, epsilon: f32 },
    ...
    PreciseRmsNorm { hidden_size: u32, epsilon: f32 },
    /// GH-559: Shared-memory RMSNorm (no warp shuffles) for Blackwell sm_121
    SharedMemRmsNorm { hidden_size: u32, epsilon: f32 },
