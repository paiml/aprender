...
fn print_playbook_results(result: &aprender_qa_runner::ExecutionResult) {
...
fn save_playbook_evidence(result: &aprender_qa_runner::ExecutionResult, output_dir: &PathBuf) -> bool {
...
fn write_markdown_report(
    ...
    let markdown = aprender_qa_report::markdown::generate_rag_markdown(mqs_score, popperian_score, collector);
