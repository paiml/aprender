...
pub struct Extraction {
    ...
    /// #3560 R2: the mdbook source pages, what they name, and whether SUMMARY.md links them.
    pub book: book::BookStats,
...
pub fn all_with(
    ...
    out.book = book::extract(contract_dir, &mut out.graph);
