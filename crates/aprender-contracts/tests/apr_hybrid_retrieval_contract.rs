...
//!    FALSIFY-HYBRID-001 (recall improvement),
//!    FALSIFY-HYBRID-002 (trait equivalence),
//!    FALSIFY-HYBRID-003 (pluggable Tokenizer trait), and
//!    FALSIFY-HYBRID-004 (build perf budget), in id order (a gap fails
//!    contract_data_integrity). All four
...
fn apr_hybrid_retrieval_contract_has_exactly_four_conditions() {
    ...
    assert_eq!(
        ...
        "HELIX-IDEA-005 ships exactly 4 falsification gates \
         (FALSIFY-HYBRID-001..004); contract has {}. \
...
#[test]
fn apr_hybrid_retrieval_contract_ids_are_hybrid_001_through_004() {
    let contract = load_contract();
