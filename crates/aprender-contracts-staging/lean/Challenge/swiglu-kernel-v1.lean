...
-- GENERATED by `pv challenge gen` (PVL-001 EV-7a) for contract `swiglu-kernel-v1`. Do not edit: `pv challenge check` regenerates it and fails on any difference.
...
theorem _root_.PvlChallenge.ProvableContracts.Fusion.swiglu_fusion_correct : ∀ (f : Int → Int) (u v : List Int), swigluFused f u v = hmul (vmap f u) v := sorry
