...
PY
  ...
  # $THINK is whitelisted at parse; $SHA12_MODEL is a sha prefix. Assert it where the path is made (#4099).
  case "$SHA12" in ""|/*|*..*) decline "refusing cell root '$SHA12' (empty, absolute, or a '..' segment)" || exit 2 ;; esac
