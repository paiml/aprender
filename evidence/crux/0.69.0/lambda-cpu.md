# CRUX inference dogfood: 0.69.0 on lambda (cpu lane)

apr `apr 0.69.0 (afb05a3de)` · llama.cpp `version: 0.4.1-dev (build 10987, commit d1d3c3396)` · ollama `0.5.7` · judged 2026-09-21T17:41Z

**PASS**: 3 cells, 0 RED, 3 GREEN, 0 ALL_WRONG, 0 UNJUDGED.

| model | verb | thinking | prompt | verdict | apr | llama.cpp | ollama | token parity |
|---|---|---|---|---|---|---|---|---|
| qwen2.5-coder-1.5b-instruct-q4_k_m.gguf | run | off | golden-2plus2 | **GREEN** | ✅ 4 | ✅ 2 + 2 equals 4. | ⛔ refused: ollama 0.5.7 imported the GGUF with no chat templa… | ≠ (apr 46 vs 36; first diff 1) |
...
| qwen2.5-coder-1.5b-instruct-q4_k_m.gguf | run | off | golden-paris | **GREEN** | ✅ The capital of France is Paris. | ✅ The capital of France is Paris. | ⛔ refused: ollama 0.5.7 imported the GGUF with no chat templa… | ≠ (apr 46 vs 36; first diff 1) |
